...
$.fn.autoComplete = function(options) {
    ...
    if (!$results.length) $results = $('<ul>', {id: 'autoCompleteResults', style: 'display:none'}).appendTo('body');
        ...
        $input.keyup(function(e) {
            ...
            autoPrompt: function() {
                ...
                $results
                    ...
                    .undelegate('.autoComplete')
                    .delegate('li', {
                        'mouseenter.autoComplete': function() {
            ...
            itemFocus: function(e, li) {
                $(li).addClass('autoCompleteSelection');
            },
            itemBlur: function(e, li) {
